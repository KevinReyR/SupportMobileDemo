-- Configure real contractor contract types and default new drafts to SOLO ARL.

insert into public.contract_type(id, name, description) values
  (1, 'DIRECTO', 'Contrato directo'),
  (2, 'PAQUETE COMPLETO', 'Contrato paquete completo'),
  (3, 'SOLO ARL', 'Contrato solo ARL')
